...
<page>
    ...
    <gridLayout>
        <collectionView {items} iosOverflowSafeArea="true" colWidth="50%" rowHeight="200" on:itemTap={onItemTap} on:loadMoreItems={onLoadMoreItems} automationText="collectionView">
            <Template let:item>
