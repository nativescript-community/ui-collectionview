...
const gridViewMangleExcludes = require("nativescript-grid-view/uglify-mangle-excludes").default;
...
function getPlugins(platform, env) {
    let plugins = [
        ...
        new CopyWebpackPlugin([
            ...
            { from: "**/*.xml" },
            {
                from: "**/*.scss",
                to: "[path][name].css",
                ignore:["**/*.android.scss", "**/*.ios.scss", "**/_*.scss"],
    ...
    if (env.uglify) {
        ...
        plugins.push(new webpack.optimize.UglifyJsPlugin({
            mangle: { except: nsWebpack.uglifyMangleExcludes.concat(gridViewMangleExcludes) },
            compress,
        }));
    }
...
function transformSass(content, path) {
