				...
				export module advrecyclerview {
					export module adapter {
						export class AdapterPath extends javalangObject {
							...
							public append(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject): com.h6ah4i.android.widget.advrecyclerview.adapter.AdapterPath;
						}
					}
				}
			}
				...
				export module advrecyclerview {
					export module adapter {
						export class AdapterPathSegment extends javalangObject {
							public adapter: androidsupportv7widgetRecyclerViewAdapter;
							public tag: javalangObject;
							public constructor(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject);
						}
					}
				}
			}
				...
				export module advrecyclerview {
					export module adapter {
						export class BridgeAdapterDataObserver extends androidsupportv7widgetRecyclerViewAdapterDataObserver {
							...
							public constructor(param0: com.h6ah4i.android.widget.advrecyclerview.adapter.BridgeAdapterDataObserver.Subscriber, param1: androidsupportv7widgetRecyclerViewAdapter, param2: javalangObject);
						...
						export module BridgeAdapterDataObserver {
							export class Subscriber extends javalangObject {
								...
								public onBridgedAdapterItemRangeRemoved(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number): void;
				...
				export module advrecyclerview {
					export module adapter {
						export class SimpleWrapperAdapter extends androidsupportv7widgetRecyclerViewAdapter implements com.h6ah4i.android.widget.advrecyclerview.adapter.WrapperAdapter, com.h6ah4i.android.widget.advrecyclerview.adapter.BridgeAdapterDataObserver.Subscriber {
							...
							public getWrappedAdapter(): androidsupportv7widgetRecyclerViewAdapter;
				...
				export module advrecyclerview {
					export module composedadapter {
						export class AdaptersSet extends javalangObject {
							...
							public removeAdapter(param0: com.h6ah4i.android.widget.advrecyclerview.composedadapter.ComposedChildAdapterTag): androidsupportv7widgetRecyclerViewAdapter;
	...
	export module h6ah4i {
		export module android {
			export module widget {
				export module advrecyclerview {
					export module composedadapter {
						export class ComposedAdapter extends androidsupportv7widgetRecyclerViewAdapter implements com.h6ah4i.android.widget.advrecyclerview.adapter.WrapperAdapter, com.h6ah4i.android.widget.advrecyclerview.adapter.BridgeAdapterDataObserver.Subscriber {
							public static NO_SEGMENTED_POSITION: number;
							public onBridgedAdapterItemRangeInserted(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number): void;
							public getItemId(param0: number): number;
							public getItemViewType(param0: number): number;
							...
							public onBridgedAdapterItemRangeRemoved(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number): void;
							public onViewDetachedFromWindow(param0: androidsupportv7widgetRecyclerViewViewHolder, param1: number): void;
							public addAdapter(param0: androidsupportv7widgetRecyclerViewAdapter): com.h6ah4i.android.widget.advrecyclerview.composedadapter.ComposedChildAdapterTag;
							public addAdapter(param0: androidsupportv7widgetRecyclerViewAdapter, param1: number): com.h6ah4i.android.widget.advrecyclerview.composedadapter.ComposedChildAdapterTag;
							public onViewRecycled(param0: androidsupportv7widgetRecyclerViewViewHolder, param1: number): void;
							public onViewRecycled(param0: androidsupportv7widgetRecyclerViewViewHolder): void;
				...
				export module advrecyclerview {
					export module composedadapter {
						export class ComposedChildAdapterDataObserver extends com.h6ah4i.android.widget.advrecyclerview.adapter.BridgeAdapterDataObserver {
							public constructor();
							public constructor(param0: com.h6ah4i.android.widget.advrecyclerview.adapter.BridgeAdapterDataObserver.Subscriber, param1: androidsupportv7widgetRecyclerViewAdapter);
				...
				export module advrecyclerview {
					export module draggable {
						export class RecyclerViewDragDropManager extends javalangObject implements com.h6ah4i.android.widget.advrecyclerview.draggable.DraggableItemConstants {
							...
							public createWrappedAdapter(param0: androidsupportv7widgetRecyclerViewAdapter): androidsupportv7widgetRecyclerViewAdapter;
							public release(): void;
				...
				export module advrecyclerview {
					export module headerfooter {
						export abstract class AbstractHeaderFooterWrapperAdapter<HVH, FVH> extends com.h6ah4i.android.widget.advrecyclerview.composedadapter.ComposedAdapter {
							...
							public onBridgedAdapterRangeMoved(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number, param4: number): void;
							public getHeaderAdapter(): androidsupportv7widgetRecyclerViewAdapter;
							...
							public getWrappedAdapter(): androidsupportv7widgetRecyclerViewAdapter;
							public onBridgedAdapterItemRangeChanged(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number, param4: javalangObject): void;
							public getFooterAdapter(): androidsupportv7widgetRecyclerViewAdapter;
						}
				...
				export module advrecyclerview {
					export module swipeable {
						export class SwipeableItemWrapperAdapter extends com.h6ah4i.android.widget.advrecyclerview.utils.BaseWrapperAdapter {
							...
							public release(): void;
							public onCreateViewHolder(param0: androidviewViewGroup, param1: number): androidsupportv7widgetRecyclerViewViewHolder;
							public constructor(param0: com.h6ah4i.android.widget.advrecyclerview.swipeable.RecyclerViewSwipeManager, param1: androidsupportv7widgetRecyclerViewAdapter);
							public onBridgedAdapterRangeMoved(param0: androidsupportv7widgetRecyclerViewAdapter, param1: javalangObject, param2: number, param3: number, param4: number): void;
							public onHandleWrappedAdapterItemRangeRemoved(param0: number, param1: number): void;
							public onHandleWrappedAdapterItemRangeChanged(param0: number, param1: number, param2: javalangObject): void;
							public onHandleWrappedAdapterItemRangeChanged(param0: number, param1: number): void;
				...
				export module advrecyclerview {
					export module utils {
						export class WrappedAdapterUtils extends javalangObject {
							public static invokeOnViewRecycled(param0: androidsupportv7widgetRecyclerViewAdapter, param1: androidsupportv7widgetRecyclerViewViewHolder, param2: number): void;
							public static invokeOnFailedToRecycleView(param0: androidsupportv7widgetRecyclerViewAdapter, param1: androidsupportv7widgetRecyclerViewViewHolder, param2: number): boolean;
							public static invokeOnViewDetachedFromWindow(param0: androidsupportv7widgetRecyclerViewAdapter, param1: androidsupportv7widgetRecyclerViewViewHolder, param2: number): void;
							public static invokeOnViewAttachedToWindow(param0: androidsupportv7widgetRecyclerViewAdapter, param1: androidsupportv7widgetRecyclerViewViewHolder, param2: number): void;
						}
					}
				}
			}
				...
				export module advrecyclerview {
					export module utils {
						export class WrapperAdapterUtils extends javalangObject {
							public static unwrapPosition(param0: androidsupportv7widgetRecyclerViewAdapter, param1: androidsupportv7widgetRecyclerViewAdapter, param2: javalangObject, param3: number): number;
